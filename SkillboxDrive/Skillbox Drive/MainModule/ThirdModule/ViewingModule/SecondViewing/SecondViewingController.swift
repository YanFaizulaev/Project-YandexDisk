...
class SecondViewingController: TableViewControllerDefault {
    ...
    private let fileCellIndentifier = "SecondViewingControllerCell"
    ...
    override func viewDidLoad() {
        ...
        tableView.register(SecondViewingControllerCell.self, forCellReuseIdentifier: fileCellIndentifier)
    }
...
extension SecondViewingController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: fileCellIndentifier) as? SecondViewingControllerCell
